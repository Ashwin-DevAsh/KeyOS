...
class OptionsPopupView @JvmOverloads constructor(context: Context?, attrs: AttributeSet?, defStyleAttr: Int = 0) : ArrowPopup(context, attrs, defStyleAttr), View.OnClickListener, View.OnLongClickListener {
    ...
    companion object {
        ...
        fun showDefaultOptions(launcher: Launcher, x: Float, y: Float) {
            ...
            options.add(OptionItem(R.string.exit_button_text, R.drawable.ic_power_settings_new_24px,
            ...
            val launcher = KioskLauncher.getLauncher(v.context)
             ...
             fun startSettingsHelper(){
                ...
                if(password== User.user?.password){
                    ...
                    getProgress(v,launcher.getString(R.string.loading_settings))
                    Handler()
                            .postDelayed({
        ...
        fun exitKeyOs(v: View): Boolean {
            ...
            fun exitKeyOsHelper(){
                ...
                if(password==User.user?.password){
                    exitDialog.dismiss()
                    getProgress(v,launcher.getString(R.string.exiting_keyos))
                    Handler()
                            .postDelayed({
