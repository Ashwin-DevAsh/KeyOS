...
class FolderGridSizeDialogFragmentCompat : PreferenceDialogFragmentCompat(), ColorEngine.OnColorChangeListener {

    private val gridSizePreference get() = preference as FolderGridSizePreference
    ...
    companion object {
        const val SAVE_STATE_ROWS = "folder_rows"
        const val SAVE_STATE_COLUMNS = "folder_columns"

        fun newInstance(key: String?) = FolderGridSizeDialogFragmentCompat().apply {
