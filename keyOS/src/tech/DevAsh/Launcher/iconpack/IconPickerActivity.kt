...
import tech.DevAsh.Launcher.iconpack.EditIconActivity.Companion.EXTRA_ENTRY
import tech.DevAsh.Launcher.settings.ui.SettingsBaseActivity
import tech.DevAsh.Launcher.views.FadingImageView
...
class IconPickerActivity : SettingsBaseActivity(), View.OnLayoutChangeListener, SearchView.OnQueryTextListener {
    ...
    private val showDebugInfo = KioskPrefs.showDebugInfo
