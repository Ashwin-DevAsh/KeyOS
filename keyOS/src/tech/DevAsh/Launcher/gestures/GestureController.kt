...
import tech.DevAsh.Launcher.gestures.gestures.*
...
class GestureController(val launcher: KioskLauncher) : TouchController {

    private val prefs = launcher.KioskPrefs
    ...
    companion object {
        ...
        private val LEGACY_SLEEP_HANDLERS = listOf(
                "ch.deletescape.keyOS.Launcher.gestures.handlers.SleepGestureHandlerDeviceAdmin",
                "ch.deletescape.keyOS.Launcher.gestures.handlers.SleepGestureHandlerAccessibility",
                "ch.deletescape.keyOS.Launcher.gestures.handlers.SleepGestureHandlerRoot")
