...
import tech.DevAsh.Launcher.settings.ui.SettingsActivity.EXTRA_FRAGMENT_ARG_KEY
import tech.DevAsh.Launcher.settings.ui.SettingsActivity.SubSettingsFragment.*
    ...
    class SearchAdapter(private val activity: SettingsSearchActivity) : androidx.recyclerview.widget.RecyclerView.Adapter<SearchAdapter.Holder>() {
        ...
        open class Holder(itemView: View) : androidx.recyclerview.widget.RecyclerView.ViewHolder(itemView) {
            ...
            open fun onBind(activity: SettingsSearchActivity, entry: SearchIndex.SettingsEntry) {
                ...
                if (itemView.context.KioskPrefs.showDebugInfo) {
